  ...
  return (
    ...
    <header>
      ...
      <div className='nav w-full flex justify-between items-center h-24  mx-auto px-4 text-white'>
          ...
          <div className='bar block md:hidden' onClick={() =>  handleNav()}>
            {nav ? <AiOutlineClose size={30} className='text-black'/> : <AiOutlineMenu size={30} />}
          </div>
          
          <div className={nav ? 'navDesplegable ' : 'nav_desplegable_disable' }>
     {/*      <div className={navMovile ? 'navDesplegable ' : null}> */}
